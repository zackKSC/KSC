...
#          key = cv2.waitKey(5) & 0xFF
         ...
         if fing_num[0] == fing_num[1] and fing_num[1] == fing_num[2] and fing_num[2] == fing_num[3] and fing_num[3] == fing_num[4] and fing_num[4] == fing_num[5]:
            return answer
